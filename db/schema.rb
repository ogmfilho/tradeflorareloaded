...
ActiveRecord::Schema.define(version: 2020_10_06_175016) do
  ...
  create_table "area_searches", force: :cascade do |t|
    ...
    t.string "states_id", default: [], array: true
    t.string "cities_id", default: [], array: true
    t.string "basins_id", default: [], array: true
  end
  ...
  create_table "reports", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["trade_id"], name: "index_reports_on_trade_id"
  ...
  add_foreign_key "reports", "trades"
